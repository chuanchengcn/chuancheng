...
public class DemoController extends BaseController {
	...
	public String initHome(){
		System.out.println("initHome4444444444444");
		ModelMap model=new ModelMap();// 如果自己new 一个 不会当做值传入
		return	this.buildSuccess(model, "/error/404Page", "error", "sb");
		//return "other/error";
	}
...
//		modelAndView.addObject(jsonObject);
	...
	@RequestMapping(value="/freemakerIndex",method={RequestMethod.GET}) 
