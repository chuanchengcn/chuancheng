...
public class BaseController implements ApplicationContextAware {
	...
	protected <T> ModelAndView buildModelAndViewParamError(ModelMap model,String pageUrl,HashMap<String, Object> errors){
		model.addAttribute("status", WebResponseConstant.RESPONSE_STATUS_SYSTEM_ERROR);
		model.addAllAttributes(errors);
		ModelAndView modelAndView=new ModelAndView();
	...
	protected <T> ModelAndView buildModelAndViewParamError(ModelMap model,String pageUrl,String field,String message){
		errors = new HashMap<String, Object>();
		errors.put(field, message);
		model.addAttribute("status", WebResponseConstant.RESPONSE_STATUS_BUSINESS_ERROR);
		model.addAllAttributes(errors);
	...
	protected <T> ModelAndView buildModelAndViewBusinessError(ModelMap model,String pageUrl,String message){
		model.addAttribute("message", message);
		model.addAttribute("status", WebResponseConstant.RESPONSE_STATUS_BUSINESS_ERROR);
		ModelAndView modelAndView=new ModelAndView();
		modelAndView.setViewName(pageUrl);
