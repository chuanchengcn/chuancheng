...
public class GlobalConstant {
	...
	private static String PROFESSOR_PATH="";
	...
	public static String getPROFESSOR_PATH() {
		return PROFESSOR_PATH;
	}
	public static void setPROFESSOR_PATH(String pROFESSOR_PATH) {
